...
project = 'fMRIPost-tedana'
author = 'The fMRIPost-tedana developers'
...
latex_documents = [
    (master_doc, 'fmripost_tedana.tex', 'fMRIPost-tedana Documentation', author, 'manual'),
]
...
man_pages = [(master_doc, 'fmripost-tedana', 'fMRIPost-tedana Documentation', [author], 1)]
...
linkcode_resolve = make_linkcode_resolve(
    'fmripost_tedana',
    'https://github.com/nipreps/fMRIPost-tedana/blob/{revision}/{package}/{path}#L{lineno}',
)
