...
Installation
------------
*fMRIPost-tedana* should be installed using container technologies.

.. code-block:: bash
  docker pull me-ica/fmripost-tedana:main


Containerized execution (Docker and Singularity)
================================================
*fMRIPost-tedana* is a *NiPreps* application, and therefore follows some overarching principles
...
---------------------
*fMRIPost-tedana* is written using Python 3.8 (or above), and is based on
nipype_.

*fMRIPost-tedana* requires some other neuroimaging software tools that are
...
===============================================
If you intend to run *fMRIPost-tedana* on a remote system, you will need to
