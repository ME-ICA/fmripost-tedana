...
---------------------------------------------------
*fMRIPost-tedana* is a *NiPreps* application, and abides by the
...
---------------------------------------
We believe that *fMRIPost-tedana* must be free to use, inspect, and critique.
...
.. automodule:: fmripost_tedana.config
   :members: from_dict, load, get, dumps, to_filename, init_spaces

Workflows
---------

.. automodule:: fmripost_tedana.workflows.base
