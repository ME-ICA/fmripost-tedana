...
def write_derivative_description(input_dir, output_dir, dataset_links=None):
    ...
    from fmripost_tedana import __version__

    DOWNLOAD_URL = f'https://github.com/nipreps/fmripost_tedana/archive/{__version__}.tar.gz'
    ...
    # Add GeneratedBy from fMRIPost-tedana
    ...
    if 'FMRIPOST_TEDANA_DOCKER_TAG' in os.environ:
        desc['GeneratedBy'][0]['Container'] = {
            'Type': 'docker',
            'Tag': f'nipreps/fmripost_tedana:{os.environ["FMRIPOST_TEDANA_DOCKER_TAG"]}',
        }

    if 'FMRIPOST_TEDANA__SINGULARITY_URL' in os.environ:
        desc['GeneratedBy'][0]['Container'] = {
            'Type': 'singularity',
            'URI': os.getenv('FMRIPOST_TEDANA__SINGULARITY_URL'),
        }
