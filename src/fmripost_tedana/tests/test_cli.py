...
from fmripost_tedana.cli import run
from fmripost_tedana.cli.parser import parse_args
from fmripost_tedana.cli.workflow import build_boilerplate, build_workflow
from fmripost_tedana.reports.core import generate_reports
from fmripost_tedana.tests.utils import (
    check_generated_files,
    download_test_data,
    get_test_data_path,
)
from fmripost_tedana.utils.bids import write_derivative_description
...
def _run_and_generate(test_name, parameters, test_main=True):
    ...
    if test_main:
        ...
        argv = ['fmripost_tedana'] + parameters
